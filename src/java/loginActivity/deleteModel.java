...
public class deleteModel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            CallableStatement cstm = conn.prepareCall("{call mp_deleteModel(?)}");
            cstm.setString(1, model_name);
            cstm.executeUpdate();
            response.sendRedirect("portal.jsp?delmodel=Model "+model_name+" was deleted.");
        }
